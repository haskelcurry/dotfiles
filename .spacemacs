...
you should place your code here."
  ...
  (defun in-github-nucleus ()
    (interactive)
    (in-github "https://git.cgm.ag/cgm.us.gat/nucleus-frontend/blob/develop"))

  (defun in-github-gat ()
    (interactive)
    (in-github "https://git.cgm.ag/cgm.gss.gat/template-frontend/blob/develop"))

  (defun in-github-fd ()
    (interactive)
    (in-github "https://git.cgm.ag/cgm.gss.gat/form-designer/blob/develop"))
